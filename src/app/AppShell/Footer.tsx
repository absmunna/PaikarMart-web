...
export const Footer = () => {
  return (
    <footer className="w-full bg-[#030906] border-t border-orange-500/10 mt-auto pt-6 pb-28 md:pb-6 px-4 md:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-white/[0.04] text-left">
          ...
          <div className="space-y-2 max-w-xl">
            <div className="flex items-center gap-2">
              <span className="text-sm md:text-base font-black text-white tracking-tight">
                Paikar<span className="text-orange-400">Mart</span>
              </span>
              <span className="text-[8px] px-1.5 py-0.5 bg-orange-500/10 text-orange-400 border border-orange-500/20 rounded font-black uppercase">
            ...
            <div className="flex items-center gap-1.5 text-[8.5px] text-orange-400 bg-orange-500/5 border border-orange-500/10 px-2 py-0.5 rounded w-fit">
          ...
          <div className="flex flex-wrap items-center gap-x-5 gap-y-1.5 text-[10px] md:text-[11px] font-black text-zinc-400">
            ...
            >
              <FileText className="w-3.5 h-3.5 text-orange-500/65" />
            ...
            <NavLink 
              ...
              className="hover:text-orange-400 transition-colors flex items-center gap-1.5"
            >
              <HelpCircle className="w-3.5 h-3.5 text-orange-500/65" />
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center justify-center gap-1 text-[8px] font-black opacity-85">
            ...
            <span className="px-1.5 py-0.5 rounded bg-orange-500/5 text-orange-400 border border-orange-500/10 font-bold">COD / কুরিয়ার</span>
          </div>
        </div>
