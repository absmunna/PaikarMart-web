...
const navItems = [
  ...
  { icon: LayoutGrid, label: "Apps", href: "/apps", isCenter: true },
      ...
      {navItems.map((item) => {
        ...
        if (item.isCenter) {
          return (
            ...
            >
              <div className="flex h-full w-full items-center justify-center rounded-full border border-[#FF7A00]/30 text-[#FF7A00]">
