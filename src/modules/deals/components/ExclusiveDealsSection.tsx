  ...
  return (
    <section className="space-y-6">
      <div className="flex items-center justify-between px-2">
        ...
        <Link 
          to="/marketplace" 
          className="flex items-center gap-2 text-[10px] font-black text-orange-400 uppercase tracking-widest hover:text-orange-300 transition-colors group"
        >
      ...
      {/* Trust Banner mini */}
      <div className="mx-2 p-3 rounded-2xl bg-orange-500/5 border border-orange-500/10 flex items-center justify-center gap-4">
        <div className="flex items-center gap-2">
          <Zap className="w-3 h-3 text-orange-400" />
          <span className="text-[9px] font-black text-orange-300 uppercase tracking-[0.2em]">Verified PK Store Exclusive</span>
        </div>
        <div className="w-1 h-1 rounded-full bg-orange-900" />
