...
export default function LoginPage() {
  ...
  const jamdaniBg = "data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0 L60 30 L30 60 L0 30 Z M30 15 L45 30 L30 45 L15 30 Z M30 25 L35 30 L30 35 L25 30 Z' fill='%23f97316' fill-opacity='0.035' fill-rule='evenodd'/%3E%3C/svg%3E";
  ...
  return (
    ...
    >
      <div className="absolute top-0 right-0 -m-12 w-80 h-80 bg-orange-500/10 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 -m-12 w-80 h-80 bg-orange-500/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="w-full max-w-[420px] relative">
        ...
        <div className="text-center mb-8 relative z-10">
          <div className="inline-flex items-center justify-center h-16 w-16 rounded-[1.5rem] bg-gradient-to-br from-orange-500/20 to-orange-600/20 border border-orange-500/30 mb-4 shadow-[0_0_24px_rgba(249,115,22,0.15)] animate-bounce-slow">
        ...
        <div className="rounded-[2rem] border border-gray-200/50 dark:border-white/10 bg-white/80 dark:bg-black/40 backdrop-blur-xl shadow-[0_12px_45px_rgba(249,115,22,0.06)] p-6 relative z-10">
          <div className="space-y-6">
            <PhoneLoginForm />
            
            <div className="flex items-center justify-end">
              <Link to="/auth/forgot-password" className="text-xs text-orange-500 hover:text-orange-600 hover:underline transition-colors font-bold">
        ...
        <div className="mt-8 relative z-10">
          <Link to="/auth/register" className="flex items-center justify-between p-4.5 rounded-[1.25rem] bg-white/70 dark:bg-white/5 hover:bg-white/95 dark:hover:bg-white/10 border border-gray-200/50 dark:border-white/5 backdrop-blur-md shadow-sm hover:shadow-md transition-all duration-300 group cursor-pointer">
             <div className="flex items-center gap-3.5">
                <div className="p-2.5 rounded-xl bg-orange-500/10 text-orange-500 transition-transform duration-350 group-hover:scale-105">
                   <UserPlus className="w-5.5 h-5.5" />
                </div>
                <div className="text-left">
                   <h4 className="text-sm font-bold text-zinc-900 dark:text-white group-hover:text-orange-500 transition-colors">{isBn ? "নতুন অ্যাকাউন্ট খুলুন" : "Create Account"}</h4>
                   <p className="text-xs text-zinc-500 dark:text-zinc-400 font-medium">{isBn ? "নতুন ব্যবহারকারীদের জন্য" : "For new users"}</p>
                </div>
             </div>
             <ArrowRight className="w-5 h-5 text-zinc-400 group-hover:text-orange-500 group-hover:translate-x-1.5 transition-all duration-300" />
          </Link>
        </div>
      </div>
    </div>
